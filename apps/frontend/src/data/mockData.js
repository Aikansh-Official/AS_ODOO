...
export const MOCK_DRIVERS = [
  { id: 'DRV-001', name: 'Marcus Vance', licenseNumber: 'CDL-MV-2021', licenseCategory: 'CE', licenseExpiry: '2027-08-15', contactNumber: '+1-555-0101', safetyScore: 92, status: 'On Trip' },
  { id: 'DRV-002', name: 'Sarah Jenkins', licenseNumber: 'CDL-SJ-2020', licenseCategory: 'C', licenseExpiry: '2027-03-22', contactNumber: '+1-555-0102', safetyScore: 88, status: 'On Trip' },
  { id: 'DRV-003', name: 'Elena Rostova', licenseNumber: 'CDL-ER-2019', licenseCategory: 'CE', licenseExpiry: '2026-11-30', contactNumber: '+1-555-0103', safetyScore: 95, status: 'On Trip' },
  { id: 'DRV-004', name: 'David Miller', licenseNumber: 'CDL-DM-2018', licenseCategory: 'B', licenseExpiry: '2025-01-10', contactNumber: '+1-555-0104', safetyScore: 71, status: 'Available' },
  { id: 'DRV-005', name: 'James Carter', licenseNumber: 'CDL-JC-2022', licenseCategory: 'CE', licenseExpiry: '2028-06-01', contactNumber: '+1-555-0105', safetyScore: 84, status: 'On Trip' },
  { id: 'DRV-006', name: 'Alex Operator', licenseNumber: 'CDL-AO-2023', licenseCategory: 'C', licenseExpiry: '2029-02-28', contactNumber: '+1-555-0106', safetyScore: 90, status: 'Available' },
  { id: 'DRV-007', name: 'John Doe', licenseNumber: 'CDL-JD-2017', licenseCategory: 'D', licenseExpiry: '2026-09-15', contactNumber: '+1-555-0107', safetyScore: 45, status: 'Suspended' },
  { id: 'DRV-008', name: 'Maria Santos', licenseNumber: 'CDL-MS-2021', licenseCategory: 'CE', licenseExpiry: '2027-12-01', contactNumber: '+1-555-0108', safetyScore: 97, status: 'Off Duty' },
];
...
export const MOCK_TRUCKS = [
  ...
  { id: 'TRK-7712', name: 'Rivian Commercial', type: 'EV', licenseNumber: 'GA-5091B', maxCapacity: 12000, currentCargoWeight: 10000, fuelLevel: 90, odometer: 8500, acquisitionCost: 95000, journeyProgress: 10, driverId: 'DRV-005', driver: 'James Carter', geohash: 'dn5bpf', city: 'Atlanta', status: 'On Trip', speed: '58 mph', cargo: 'Dry Goods', route: 'ATL -> MIA', destCity: 'Miami', destCoords: [25.7617, -80.1918] },
